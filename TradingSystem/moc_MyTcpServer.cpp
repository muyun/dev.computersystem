...
QT_MOC_LITERAL(8, 58, 17),
QT_MOC_LITERAL(9, 76, 12),
QT_MOC_LITERAL(10, 89, 12)
    },
    "MyTcpServer\0toDisplay\0\0decoder\0id\0"
    "message\0sendMessage\0num\0onDisconnectedSIG\0"
    "MyTcpSocket*\0brokenSocket\0"
};
...
void MyTcpServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->onDisconnectedSIG((*reinterpret_cast< MyTcpSocket*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyTcpServer::toDisplay)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void MyTcpServer::toDisplay(QString _t1)
{
